...
public class CartController {
    ...
    public CartResponseDto removeFromCart(@AuthenticationPrincipal CustomUserDetails user, @PathVariable Long id){
       return cartOrchestrator.removeFromCart(user.getUser().getUserId(),id);
    }
    @GetMapping
    @ResponseStatus(HttpStatus.OK)
